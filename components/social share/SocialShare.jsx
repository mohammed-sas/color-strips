...
const SocialShare = ({setShowSocial}) => {
  ...
  for(let i in palettes)
    output+=`color${Number(i)+1} : ${palettes[i]}, `
  return (
    <Flex
      position="fixed"
      w="100vw"
    ...
    >
      <Flex bg="white" h="60%" w="70%" zIndex={10} borderRadius="1rem">
        ...
        <Flex flexBasis="50%" flexDirection="column" alignItems="center" justifyContent="center" gap={10} position="relative">
            <IconButton icon={<BiXCircle/>} position="absolute" top={1} right={1}  onClick={()=>setShowSocial(false)}/>
            <Text fontWeight="bold" fontSize="lg">Share your palettes</Text>
